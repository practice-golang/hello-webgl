package main // import "hello-webgl.wasm"
...
// TypedArrayOf 없어진거
// https://github.com/bobcob7/wasm-basic-triangle/issues/2
// https://github.com/hajimehoshi/ebiten/blob/c52e043006dacb6684d4b2ee0dc135cf9f0ddec4/internal/jsutil/go113_js.go
...
func main() {
	...
	vertices, _ := SliceToTypedArray(verticesNative)
	js.Global().Set("vertices", vertices)
	...
	indices, _ := SliceToTypedArray(indicesNative)
	js.Global().Set("indices", indices)
